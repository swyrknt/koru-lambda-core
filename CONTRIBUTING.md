...
- **Integration tests** in `tests/` verify emergent properties
...
### Design Questions
- Reference `DESIGN_DOC.md` for the theoretical foundation
...
> "Forma Core is the foundation. Build it right once, and everything else becomes easier."
