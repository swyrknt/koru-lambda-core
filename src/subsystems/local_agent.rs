...
///
/// Subsystems anchor to a local root distinction and all state transitions
/// are computed via synthesis. All action data must be canonicalizable.
/// Uses Arc<DistinctionEngine> for thread-safe shared access.
