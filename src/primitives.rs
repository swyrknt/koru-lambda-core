...
pub trait Canonicalizable {
    fn to_canonical_structure(&self, engine: &mut DistinctionEngine) -> Distinction;
}
...
impl ByteMapping {
    ...
    pub fn map_byte_to_distinction(byte: u8, engine: &mut DistinctionEngine) -> Distinction {
