...
impl DistinctionEngine {
    ...
    fn add_relationship(&self, id_a: &str, id_b: &str) {
        ...
        self.relationships
            .insert((min.to_string(), max.to_string()), ());
    }
    ...
    pub fn synthesize(&self, a: &Distinction, b: &Distinction) -> Distinction {
        ...
        self.all_distinctions
            .insert(new_id.clone(), new_distinction.clone());
    ...
    pub fn get_state_snapshot(&self) -> (Vec<Distinction>, Vec<Relationship>) {
        (
            self.get_distinctions_snapshot(),
            self.get_relationships_snapshot(),
        )
    }
